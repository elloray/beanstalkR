...
import com.github.elloray.beanstalkR.util.Header;
...
public class MessageHandler {
  ...
  public MessageHandler(String host, int port) throws UnknownHostException,
      IOException {
  ...
  private byte[] getData(InputStream in, Response response, String ErrorCode)
    ...
    /**
     * if command line doesn't start with correct response,then don't get next
     * data body
     */
